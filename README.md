...
├── .env.example           # Exemplo de configuração do token da API
...
4. Crie o arquivo .env na raiz do projeto (igual ao .env.exemplo)
...
- O token deve estar:
  ...
  - Ou em st.secrets["CLIENT_TOKEN"] (Streamlit Cloud)
